...
int main(int argc, char* argv[])
{
    ...
    {
        cout << "\nProcess " << k << "----------" << endl;
        cout << "Finish Time: " << procList[k].timeFinished << endl;
        cout << "Turnaround Time: " << procList[k].timeFinished - procList[k].startTime << endl;
        avgTurnaround += procList[k].timeFinished - procList[k].startTime;
        cout << "Normalized Turnaround Time: " << procList[k].timeFinished/(float)(procList[k].timeFinished - procList[k].startTime) << endl;
        avgNormalizedTurnaround += procList[k].timeFinished/(float)(procList[k].timeFinished - procList[k].startTime);
    }
    avgTurnaround /= procList.size();
    avgNormalizedTurnaround /= procList.size();
    cout << "\nAverage turnaround time: " << avgTurnaround<< endl;
    cout << "Average normalized turnaround time: " << avgNormalizedTurnaround << endl;
